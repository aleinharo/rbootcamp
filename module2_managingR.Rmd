...
## the line above saves all of your objects so you can just pick up your analysis where you left off
getwd()
rm(list = ls())
## line above removes all items from the environment
...
# base R (provided by 12 people who control R); 
...
lm(7) 
# masked by the function we wrote
.libPaths()
...
#:: above tells R to look in the package
...
setwd('/Users/irlegsr/Box Sync/Box Sync/R BootCamp/r-bootcamp-winter-2019-master/') 
# absolute path
getwd()
setwd('r-bootcamp-winter-2019/modules') 
# relative path
...
plot(x, y)
dev.off()
## dev.off tells R you're done making changes anf to output the object
```
